"""
Django settings for clearload_39882 project.
...
ROOT_URLCONF = 'clearload_39882.urls'
...
WSGI_APPLICATION = 'clearload_39882.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "clearload_39882 API",
    "DESCRIPTION": "API documentation for clearload_39882 App",
    "VERSION": "v1",
}
